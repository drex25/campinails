        ...
        <div className="bg-white rounded-3xl shadow-lg p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <button 
              ...
              className="px-6 py-3 bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded-2xl hover:from-cyan-600 hover:to-blue-600 transition-all duration-200 transform hover:scale-105 flex items-center space-x-2 shadow-lg"
            >
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center space-x-2 mt-4 pt-4 border-t border-gray-100">
                    <button 
                      ...
                      className="flex-1 flex items-center justify-center space-x-2 py-2 px-3 bg-blue-50 text-blue-600 rounded-xl hover:bg-blue-100 transition-colors duration-200 text-sm"
                    >
                    ...
                    <button 
                      ...
                      className="flex-1 flex items-center justify-center space-x-2 py-2 px-3 bg-red-50 text-red-600 rounded-xl hover:bg-red-100 transition-colors duration-200 text-sm"
                    >
          ...
          <div className="bg-white rounded-3xl shadow-lg p-12 text-center">
            ...
            {!searchTerm && selectedCategory === 'all' && !showLowStock && (
              <button 
                ...
                className="px-6 py-3 bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded-2xl hover:from-cyan-600 hover:to-blue-600 transition-all duration-200 transform hover:scale-105"
              >

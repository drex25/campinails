...
export const NotificationsSection: React.FC = () => {
  ...
  const handleFormSuccess = () => {
    success('Notificación enviada', 'La notificación se envió correctamente');
    setShowForm(false);
  };

  const handleQuickAction = (type: string) => {
    success(`${type} enviado`, `El ${type.toLowerCase()} se envió correctamente`);
  };
        ...
        <div className="bg-white rounded-3xl shadow-lg p-6">
          <div className="flex items-center justify-between">
            ...
            <button 
              ...
              className="px-6 py-3 bg-gradient-to-r from-yellow-500 to-orange-500 text-white rounded-2xl hover:from-yellow-600 hover:to-orange-600 transition-all duration-200 transform hover:scale-105 flex items-center space-x-2 shadow-lg"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-3xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 transform hover:scale-105">
            ...
            <button 
              ...
              className="w-full py-3 bg-green-50 text-green-600 rounded-2xl hover:bg-green-100 transition-colors duration-200 font-medium"
            >
              Enviar Mensaje
            </button>
          </div>
          ...
          <div className="bg-white rounded-3xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 transform hover:scale-105">
            ...
            <button 
              ...
              className="w-full py-3 bg-blue-50 text-blue-600 rounded-2xl hover:bg-blue-100 transition-colors duration-200 font-medium"
            >
              Enviar Email
            </button>
          </div>
          ...
          <div className="bg-white rounded-3xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 transform hover:scale-105">
            ...
            <button 
              ...
              className="w-full py-3 bg-purple-50 text-purple-600 rounded-2xl hover:bg-purple-100 transition-colors duration-200 font-medium"
            >
              Enviar SMS
            </button>
          </div>

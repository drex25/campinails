...
export const EmployeesSection: React.FC = () => {
  ...
  const handleDelete = async (id: number) => {
    if (window.confirm('¿Estás segura de que quieres eliminar este empleado?')) {
      try {
        await employeeService.delete(id);
        success('Empleado eliminado', 'El empleado se eliminó correctamente');
        await loadEmployees();
      } catch (err) {
        ...
        <div className="bg-white rounded-3xl shadow-lg p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <button
              ...
              className="px-6 py-3 bg-gradient-to-r from-indigo-500 to-purple-500 text-white rounded-2xl hover:from-indigo-600 hover:to-purple-600 transition-all duration-200 transform hover:scale-105 flex items-center space-x-2 shadow-lg"
            >
          ...
          <div className="relative">
            <input
              ...
              className="w-full pl-4 pr-4 py-3 border border-gray-200 rounded-2xl focus:ring-4 focus:ring-indigo-100 focus:border-indigo-300 transition-all duration-300"
            />
          </div>
        </div>
          ...
          <div className="bg-white rounded-3xl shadow-lg p-12 text-center">
            ...
            {!searchTerm && (
              <button
                ...
                className="px-6 py-3 bg-gradient-to-r from-indigo-500 to-purple-500 text-white rounded-2xl hover:from-indigo-600 hover:to-purple-600 transition-all duration-200 transform hover:scale-105"
              >

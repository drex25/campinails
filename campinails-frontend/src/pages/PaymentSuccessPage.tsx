...
export const PaymentSuccessPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (status === 'approved' && externalReference) {
      // Aquí podrías hacer una llamada a la API para obtener los detalles del turno
      setAppointment({
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-rose-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl shadow-xl p-8 max-w-md w-full text-center">
        ...
        <p className="text-gray-600 mb-6">
          Tu seña ha sido procesada correctamente. Tu turno está confirmado.
        </p>
        ...
        {appointment && (
          <div className="bg-gray-50 rounded-2xl p-4 mb-6">
            <div className="flex items-center justify-center space-x-2 mb-3">
              ...
              <span className="font-medium text-gray-800">Turno Confirmado</span>
            </div>
        ...
        <div className="space-y-3 text-sm text-gray-600">
          <div className="flex items-center justify-center space-x-2">
            ...
            <span>Recibirás un recordatorio 24h antes</span>
          </div>
          <p>Te enviaremos un WhatsApp con los detalles</p>
        </div>
